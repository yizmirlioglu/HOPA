...
ASP folder:  ASP programs in the paper

Scenario:  ASP encoding of the scenarios in the paper
...
Technical Appendix.pdf : Proof of the Theorems, Full ASP encoding of HOPA and Reproducibility Checklist
...
hopa_main.lp :  The main ASP program in the paper for checking consistency of HOPA constraints

opra_consistency.lp :  The simplified version of the main ASP program which is used for checking consistency of only OPRA constraints  (this file used for OPRA experiments in the paper)
