...
print("Disjunctive Inconsistent Test has started ... ")
...
rfname_unsat = "Disj_Inconsist_Hybrid_Results_ASP1.csv"
               ...
               for adsj in num_disjunc:
                  ...
                  for agrid in grids:
                     ...
                     for agranul in granuls:
                        ...
                        inst_name_unsat = "n" + str(nobj) + "_c" + str(aconstr) + "_grid" + str(agrid) + "_disj" + str(num_disjconstr) + "x" + str(adsj) + "_unsat.lp"

                        sampleind = 0
                        while sampleind < nsample:

                           instance_folder = os.path.join(instances_upper_folder, inconsist_folder, sample_folder+str(sampleind+startsample), disj_folder )
