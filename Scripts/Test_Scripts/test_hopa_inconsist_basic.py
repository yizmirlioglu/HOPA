...
print("Basic Inconsistent Test has started ... ")
...
rfname_unsat = "Basic_Inconsist_Hybrid_Results_ASP.csv"
         ...
         for aconstr in constr_list:
            ...
            for agrid in grids:
               ...
               for agranul in granuls:
                  ...
                  inst_name_unsat = "n" + str(nobj) + "_c" + str(aconstr) + "_grid" + str(agrid) + "_basic_unsat.lp"
