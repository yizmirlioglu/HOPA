...
print("OPRA Consistent Test has started ... ")
...
rfname_sat = "Basic_OPRA_Consist_Results.csv"
         ...
         for aconstr in constr_list:
            ...
            for agranul in granuls:
               ...
               for agrid in grids:
                  ...
                  inst_name_sat = "n" + str(nobj) + "_c" + str(aconstr) + "_g" + str(agranul) + "_basic_sat.lp"

                  sampleind = 0
                  while sampleind < nsample:

                     instance_folder_sat = os.path.join(instances_upper_folder, consist_folder, sample_folder+str(sampleind+startsample), basic_folder )

                     asolver_file = solver_files_folder + "/" + asolver    #os.path.join(solver_files_folder, asolver)

                     file_inst = os.path.join(instance_folder_sat, inst_name_sat)
...
excelfile1.write("\n")
#excelfile1.write("SubDomain," + str(num_subdomain) + ",,,,,,,,,,,,")
#excelfile1.write("\n")
#excelfile1.write("Domain Size," + str(domain_size) + ",,,,,,,,,,,,")
#excelfile1.write("\n")
