...
def test_inst(solvername, instfile, cspfile, solvertype):
   ...
   outputx = str(outputx)
    #output = output[output.find(("ANSWER")) + 10:output.rfind(".") + 1]
...
print("Basic Consistent Test has started ... ")
...
#used_mem_mb=int(mem_infox.used / 1073741824.0)   # mb= 1048576.0)   #  1024.0*1024.0 
...
timeout_value = 100
intermiss = 8000.0
long_intermiss = 10000.0

startsample = 1
nsample = 100

num_objects = [40, 60, 80, 100, 120];   #
num_constr = [ [40,60], [60,100], [80,120], [100,150], [120,150] ]  # [20, 50], 
all_grids = [ [[50,100],[50,100]], [[50,100],[50]], [[50,100],[50]], [[50],[50]], [[50],[50]] ]   #, [[50,100],[50]] ]

all_granuls =  [ [[["deg3"],["deg3"]],[["deg3"],["deg3"]]], [[["deg3"],["deg3"]],[["deg3"]]], [[["deg3"],["deg3"]],[["deg3"]]], [[["deg3"]],[["deg3"]]], [[["deg3"]],[["deg3"]]] ] 
...
rfname_sat = "Basic_Consist_Hybrid_Results_ASP1.csv"
   ...
   for asolver in solver_files:
      ...
      for nobj in num_objects:
         ...
         for aconstr in constr_list:
            ...
            gridind = 0
            for agrid in grids:
               granuls = ((all_granuls[objind])[cind])[gridind]
               ...
               for agranul in granuls:
                  (((((time_sample_results[engineind])[solverind])[objind])[cind])[gridind]).append([])
                  (((((sat_sample_results[engineind])[solverind])[objind])[cind])[gridind]).append([])
                  #(((((gridx_sample_results[engineind])[solverind])[objind])[cind])[gridind]).append([])
                  #(((((gridy_sample_results[engineind])[solverind])[objind])[cind])[gridind]).append([])
                  (((((timeout_sample_results[engineind])[solverind])[objind])[cind])[gridind]).append([])
                  #(((((grid_time_results[engineind])[solverind])[objind])[cind])[gridind]).append([])
                  (((((search_time_results[engineind])[solverind])[objind])[cind])[gridind]).append([])
                  (((((cpu_time_results[engineind])[solverind])[objind])[cind])[gridind]).append([])
                  (((((memory_results[engineind])[solverind])[objind])[cind])[gridind]).append([])
                  (((((atoms_results[engineind])[solverind])[objind])[cind])[gridind]).append([])
                  (((((rules_results[engineind])[solverind])[objind])[cind])[gridind]).append([])
                  (((((vars_results[engineind])[solverind])[objind])[cind])[gridind]).append([])
                  (((((constr_results[engineind])[solverind])[objind])[cind])[gridind]).append([])

                  inst_name_sat = "n" + str(nobj) + "_c" + str(aconstr) + "_grid" + str(agrid) + "_basic_sat.lp"

                  sampleind = 0
                  while sampleind < nsample:

                     instance_folder = os.path.join(instances_upper_folder, consist_folder, sample_folder+str(sampleind+startsample), basic_folder )
                     ...
                     if (ctime < (timeout_value-1.2)):  #  no timeout
                        ((((((time_sample_results[engineind])[solverind])[objind])[cind])[gridind])[gind]).append(totalt)
                        #((((((grid_time_results[engineind])[solverind])[objind])[cind])[gridind])[gind]).append(gridfx)
                        ((((((search_time_results[engineind])[solverind])[objind])[cind])[gridind])[gind]).append(searcht)
                        ((((((cpu_time_results[engineind])[solverind])[objind])[cind])[gridind])[gind]).append(cput)  # solvetime
                        ((((((timeout_sample_results[engineind])[solverind])[objind])[cind])[gridind])[gind]).append(0) 

                        if (unsatindex >= 0):
                           ((((((sat_sample_results[engineind])[solverind])[objind])[cind])[gridind])[gind]).append(0)
                        else:
                           ((((((sat_sample_results[engineind])[solverind])[objind])[cind])[gridind])[gind]).append(1)

                     else:
                        ((((((timeout_sample_results[engineind])[solverind])[objind])[cind])[gridind])[gind]).append(1) 


                     ((((((memory_results[engineind])[solverind])[objind])[cind])[gridind])[gind]).append(mem_consume)
                     ((((((atoms_results[engineind])[solverind])[objind])[cind])[gridind])[gind]).append(atomc)
                     ((((((rules_results[engineind])[solverind])[objind])[cind])[gridind])[gind]).append(rulec)
                     ((((((vars_results[engineind])[solverind])[objind])[cind])[gridind])[gind]).append(varc)
                     ((((((constr_results[engineind])[solverind])[objind])[cind])[gridind])[gind]).append(constrc)
                     #((((((gridx_sample_results[engineind])[solverind])[objind])[cind])[gridind])[gind]).append(gridx)
                     #((((((gridy_sample_results[engineind])[solverind])[objind])[cind])[gridind])[gind]).append(gridy)
...
for aengine in engines:
   ...
   for asolver in solver_files:
      ...
      excelfile1.write("N,Constr,Grid,Granul,,Total,Ground,Search,Median,StdDev,MaxTime,MinTime,Satisfiable,Timeout,,Peak Memory,Aver Memory,Median Memory,,Peak Atoms,Peak Rules,Peak Vars,Peak Constr,,Median Atoms,Median Rules,Median Vars,Median Constr,,")
      excelfile1.write("\n")
         ...
         for aconstr in constr_list:
            ...
            for agrid in grids:
               ...
               for agranul in granuls:
                  ...
                  if len( (((((time_sample_results[engineind])[solverind])[objind])[cind])[gridind])[gind] ) > 1:
                     avertime = float(format( statistics.mean( (((((time_sample_results[engineind])[solverind])[objind])[cind])[gridind])[gind] ), '.3f') )
                     medx = float(format( statistics.median( (((((time_sample_results[engineind])[solverind])[objind])[cind])[gridind])[gind] ), '.3f') )
                     stdx = float(format( statistics.stdev( (((((time_sample_results[engineind])[solverind])[objind])[cind])[gridind])[gind] ), '.3f') )
                     maxtime = float(format( max( (((((time_sample_results[engineind])[solverind])[objind])[cind])[gridind])[gind] ), '.3f') )
                     mintime = float(format( min( (((((time_sample_results[engineind])[solverind])[objind])[cind])[gridind])[gind] ), '.3f') )

                     avercpu = float(format( statistics.mean( (((((cpu_time_results[engineind])[solverind])[objind])[cind])[gridind])[gind] ), '.3f') )
                     aversearch = float(format( statistics.mean( (((((search_time_results[engineind])[solverind])[objind])[cind])[gridind])[gind] ), '.3f') )
                  ...
                  satsum = sum( (((((sat_sample_results[engineind])[solverind])[objind])[cind])[gridind])[gind] )
                  timeoutsum = sum( (((((timeout_sample_results[engineind])[solverind])[objind])[cind])[gridind])[gind] )

                  peak_mem = float(format( max( (((((memory_results[engineind])[solverind])[objind])[cind])[gridind])[gind] ), '.3f') )
                  aver_mem = float(format( statistics.mean( (((((memory_results[engineind])[solverind])[objind])[cind])[gridind])[gind] ), '.3f') )
                  median_mem = float(format( statistics.median( (((((memory_results[engineind])[solverind])[objind])[cind])[gridind])[gind] ), '.3f') )

                  peak_atoms = max( (((((atoms_results[engineind])[solverind])[objind])[cind])[gridind])[gind] )
                  peak_rules = max( (((((rules_results[engineind])[solverind])[objind])[cind])[gridind])[gind] )
                  peak_vars = max( (((((vars_results[engineind])[solverind])[objind])[cind])[gridind])[gind] )
                  peak_constr = max( (((((constr_results[engineind])[solverind])[objind])[cind])[gridind])[gind] )

                  median_atoms = statistics.median_high( (((((atoms_results[engineind])[solverind])[objind])[cind])[gridind])[gind] )
                  median_rules = statistics.median_high( (((((rules_results[engineind])[solverind])[objind])[cind])[gridind])[gind] )
                  median_vars = statistics.median_high( (((((vars_results[engineind])[solverind])[objind])[cind])[gridind])[gind] )
                  median_constr = statistics.median_high( (((((constr_results[engineind])[solverind])[objind])[cind])[gridind])[gind] )

                  excelfile1.write(str(nobj) + "," + str(aconstr) + "," + str(agrid) + "," + str(agranul) + ",," + str(avertime) + "," + str(averground) + "," + str(aversearch) + "," + str(medx) + "," + str(stdx) + ","  + str(maxtime) + "," + str(mintime) + "," + str(satsum) + "," + str(timeoutsum) + ",," + str(peak_mem) + "," + str(aver_mem) + "," + str(median_mem) + ",," + str(peak_atoms) + "," + str(peak_rules) + "," + str(peak_vars) + "," + str(peak_constr) + ",," + str(median_atoms) + "," + str(median_rules) + "," + str(median_vars) + "," + str(median_constr) + ",," )
